...
**Note**: To install services [insight-api](https://github.com/NixPlatform/nix-insight-api) and [insight-ui](https://github.com/NixPlatform/nix-insight-ui) you'll need to clone the repositories locally.
